...
//Getting data for home page (Both Income and Expenses)
...
import com.project.euroexpensemanager.databinding.FragmentHomeBinding;
...
public class HomeFragment extends Fragment implements RecentTransactionAdapter.DeleteSubItemInterface {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        mBinding.recentTransactionsRecyclerViewId.setLayoutManager(layoutManager);
        mBinding.recentTransactionsRecyclerViewId.setHasFixedSize(true);
    ...
    private void getNewEntriesFromFireStore() {
        ...
        Repository.getNewEntries(FirebaseAuth.getInstance().getCurrentUser().getUid(), new OnGetEntriesListener() {
            @Override
            public void onLoaded(List<NewEntryModelClass> listNewEntry) {
                progressHUD.dismiss();
                Log.i(TAG, "onLoaded: listSize" + listNewEntry.size());
                adapter = new RecentTransactionAdapter(listNewEntry, getContext(), HomeFragment.this);
                mBinding.recentTransactionsRecyclerViewId.setAdapter(adapter);
